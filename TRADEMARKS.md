...
Please ask before using the project marks in a way that could imply endorsement,
official status, or project ownership.
...
Forks are welcome. Make it clear when a fork is not the official project and
preserve attribution notices required by the license.

This policy is not legal advice. It is a practical project rule for reducing
confusion and protecting the credibility of the ecosystem.
